...
class EEG_Processing {
  ...
  private void defineFilters() {
    ...
    for (int Ifilt=0;Ifilt<n_filt;Ifilt++) {
      ...
      switch (Ifilt) {
      case 0:
        //[b,a]=butter(2,[5]/(250/2)); %matlab command
        b = new double[] {  
          3.621681514928643e-03, 7.243363029857286e-03, 3.621681514928643e-03
        };       
        a = new double[] { 
          1.0f, -1.822694925196308e+00, 8.371816512560228e-01
        };
        filt_txt = "Lowpass 0-5Hz";
        short_txt = "0-5 Hz";
        break;  
      case 1:
        //[b,a]=butter(2,[15]/(250/2)); %matlab command
        b = new double[] {  
          2.785976611713603e-02, 5.571953223427206e-02, 2.785976611713603e-02
        };       
        a = new double[] { 
          1.0f, -1.475480443592646e+00, 5.869195080611904e-01
        };
        filt_txt = "Lowpass 0-15Hz";
        short_txt = "0-15 Hz";
        break;       
